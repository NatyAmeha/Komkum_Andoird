...
import com.komkum.komkum.databinding.FragmentBookSearchBinding
...
class BookSearchFragment : Fragment() , IRecyclerViewInteractionListener<MusicBrowse> {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        binding.bookInterestView.libraryItemImageView.setImageResource(R.drawable.ic_baseline_album_24)
        binding.bookInterestView.libraryItemTextview.text = "Interests"
        binding.bookInterestView.root.setOnClickListener {
            browseList.let{
...
//        }
        ...
        binding.viewAllAuthorBtn.setOnClickListener {
            searchResult?.authors?.let {
                (requireActivity() as MainActivity).movetoAuthorsList(Author.FAVORITE_AUTHORS_LIST , it)
            }
        }
    }
