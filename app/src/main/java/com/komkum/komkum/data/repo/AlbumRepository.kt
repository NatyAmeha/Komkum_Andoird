...
//               var albumSongs = appDb.songDao.getSongsByAlbumId(albumId).toSong()
               ...
               var albumResult = Album<Song<String , String> , String>(_id = album._id , name = album.name , albumCoverPath =  album.albumCoverPath , songs = alSongs , artistsName = album.artistsName.split(","))
